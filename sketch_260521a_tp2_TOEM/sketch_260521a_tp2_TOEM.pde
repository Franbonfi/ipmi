...
void draw() {  
 ...
 if (pantalla == 3){
   ...
   noStroke();
   image(animal, 20, 80, 136, 180);
   image(paisaje, 175, 80, 136, 180);
   image(persona, 330, 80, 136, 180);
   image(objvalioso, 480, 80, 136, 180);
 ...
 if (pantalla == 5){
   ...
   noStroke();
   image(obteniendoCosme, 40, 80, 270, 180);
   image(usandoCosme, 340, 80, 260, 180);
